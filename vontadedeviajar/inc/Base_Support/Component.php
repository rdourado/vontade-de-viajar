<?php
/**
 * RDourado\VdV\Base_Support\Component class
 *
 * @package vdv
 */

namespace RDourado\VdV\Base_Support;
 ...
 * * `vdv()->get_version()`
 * * `vdv()->get_asset_version( string $filepath )`
 */
class Component implements Component_Interface, Templating_Component_Interface {
	...
	/**
	 * Excludes any directory named 'source' from being scanned for theme template files.
	 *
